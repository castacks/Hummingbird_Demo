...
class VisualServo(Node):
    def __init__(self):
        ...
        # Subscribers
        self.camera_info_sub = self.create_subscription(CameraInfo, self.camera_info_sub_topic, self.camera_info_callback, 10)
        ...
        # Publishers
        self.velocity_pub = self.create_publisher(TwistStamped, self.velocity_pub_topic, 10)
        self.position_pub = self.create_publisher(PoseStamped, self.position_pub_topic, 10)
        self.img_debug_pub = self.create_publisher(Image, self.img_debug_pub_topic, 10)
        self.line_location_vis_pub = self.create_publisher(Marker, self.line_location_vis_pub_topic, 10)
    ...
    def set_params(self):
        try:
            self.declare_parameters(
                        ...
                        parameters=[
                            # Topics
                            ('camera_info_sub_topic', '/robot_1/sensors/gripper_cam/camera_info'),
                            ('rgb_image_sub_topic', '/robot_1/sensors/gripper_cam/image_rect'),
                            ('depth_image_sub_topic', '/robot_1/sensors/gripper_cam/depth'),
                            ('semantics_sub_topic', '/robot_1/sensors/gripper_cam/segmentation'),
                            # Services
                            ('activate_srv_topic', '/robot_1/behavior/toggle_visual_servo_command'),
                            # Publishers
                            ('velocity_pub_topic', '/robot_1/interface/mavros/setpoint_velocity/cmd_vel'),
                            ('position_pub_topic', '/robot_1/interface/mavros/setpoint_position/local'),
                            ('img_debug_pub_topic', '/robot_1/sensors/gripper_cam/detection_debug'),
                            ('line_location_vis_pub_topic', '/robot_1/visual_servo/line_location_visualization'),
                            # TF Params
            ...
            self.position_pub_topic = self.get_parameter('position_pub_topic').get_parameter_value().string_value
